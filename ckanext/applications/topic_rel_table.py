...
def init_db(model):
    ...
    sql = '''
                CREATE TABLE topic_rel_table_db (
                    id text NOT NULL,
    ...
    types = sa.types
    global topic_rel_table_table
    topic_rel_table_table = sa.Table('topic_rel_table', model.meta.metadata,
